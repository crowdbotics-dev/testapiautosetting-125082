...
## Project Structure
    ...
    ├── testapiautosetting_125082  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125082`
...
2. Clone this repo and `cd testapiautosetting_125082`
